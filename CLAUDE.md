...
- An instant meta refresh is a redirect (`crawl.rs::redirect_step`, shared with 3xx): same hop budget, same robots check, shell never stored. Shells that arrive via ingest/sync are skipped as `redirect`.
